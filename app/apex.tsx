...
function Picker({
  ...
  return (
    <div className="picker">
      ...
      >
        <SelectTrigger aria-label={label} className="picker-trigger">
          <SelectValue />
        </SelectTrigger>
    ...
    <div className="finder">
      <div className="finder-title">
        <span className="eyebrow">
          {t('FIND YOUR FIT', 'GĂSEȘTE KITUL TĂU')}
        </span>
        <h3>{t('What do you ride?', 'Ce conduci?')}</h3>
      </div>
      <Picker
      ...
      <Picker
        ...
        value={filters.model}
        items={[
          all(t('Select model', 'Alege modelul')),
      ...
      <main id="main">
        {!shop ? (
          <>
            ...
            <div className="finder-wrap">{finder}</div>
          ...
          <>
            ...
            <div className="finder-wrap shop-finder">{finder}</div>
            <section className="section shop-section">
              ...
              {(filters.make !== 'All' || year !== 'All') && (
                <p className="fit-note">
                  {t(
                    'These designs match your selected brand and vehicle category. Exact model and year fitment must be confirmed before ordering.',
                    'Aceste designuri corespund mărcii și categoriei selectate. Potrivirea exactă pentru model și an se confirmă înainte de comandă.',
                  )}
                </p>
              )}
              {shown.length ? (
